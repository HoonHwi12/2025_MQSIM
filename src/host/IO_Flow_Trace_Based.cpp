...
IO_Flow_Trace_Based::IO_Flow_Trace_Based(const sim_object_id_type &name, uint16_t flow_id, LHA_type start_lsa_on_device, LHA_type end_lsa_on_device, uint16_t io_queue_id,
										...
										// hoonhwi25
										unsigned int alignment_value, Utils::Address_Distribution_Type address_distribution
										// hoonhwi25
																															  ...
																															  total_requests_in_file(0), time_offset(0), alignment_value(alignment_value), address_distribution(address_distribution)
{
